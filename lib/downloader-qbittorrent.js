...
class QBittorrent extends DownloaderBase {
    ...
    addTask(url, taskparams) {
        ...
        if(typeof(taskparams.sequential) === 'boolean')
            formData.append('sequentialDownload', taskparams.sequential.toString())
        if(typeof(taskparams.firstLastPiece) === 'boolean')
            formData.append('firstLastPiecePrio', taskparams.firstLastPiece.toString())
